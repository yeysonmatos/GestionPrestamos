...
import { calculateLateDays, calculateLateAmount, calculateProportionalInterest, recalculateFrenchSchedule } from '@/lib/calculations'
import { updateLoanAfterPayment, recalculateInstallment } from '@/lib/payments'

export function useFrenchLoan({ state, setters, services }: LoanHandlerInput) {
