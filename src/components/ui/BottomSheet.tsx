  ...
  return (
    <div className="fixed inset-0 z-50" onClick={close}>
      ...
      <div
        ...
        className={`fixed bottom-0 left-0 right-0 bg-card rounded-t-2xl shadow-2xl max-h-[85vh] flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${closing ? 'translate-y-full' : ''}`}
